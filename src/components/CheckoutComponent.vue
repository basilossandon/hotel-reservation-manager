...
export default {
    ...
    created() {
        axios.get('http://158.170.35.185/:8080/api/rooms').then(response => {
            ...
            axios.get('http://158.170.35.185/:8080/api/services').then(response => {
    ...
    methods: {
        deleteReservation(room) {
            ...
            axios({
                method: "POST",
                url: "http://158.170.35.185/:8080/api/reservations/" + id + '/delete',
                data: {},
                config: {
                    headers: {
        ...
        searchBill() {
            ...
            axios.get("http://158.170.35.185/:8080/api/bills/" + id)
            .then( response => {
